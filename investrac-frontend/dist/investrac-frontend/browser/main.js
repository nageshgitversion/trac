...
var routes = [
  ...
  // Auth routes (no guard — but guestGuard redirects logged-in users)
  {
    ...
    children: [
      {
        path: "login",
        loadComponent: () => import("./chunk-R6HYHCT2.js").then((m) => m.LoginComponent)
      },
      {
        path: "register",
        loadComponent: () => import("./chunk-OVISPID5.js").then((m) => m.RegisterComponent)
      },
      {
        path: "",
        redirectTo: "login",
  ...
  // Protected routes (authGuard applied)
  {
    ...
    loadComponent: () => import("./chunk-WYIPY2LB.js").then((m) => m.HomeComponent)
  },
  {
    path: "transactions",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-Q5QECBKZ.js").then((m) => m.TransactionsComponent)
  },
  {
    path: "wallet",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-HETUXI4V.js").then((m) => m.WalletComponent)
  },
  {
    path: "portfolio",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-WI4XAFH5.js").then((m) => m.PortfolioComponent)
  },
  {
    path: "settings",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-TPSFARHT.js").then((m) => m.SettingsComponent)
  },
  // 404
  {
    path: "**",
...
var jwtInterceptor = (req, next) => {
  const authService = inject(AuthService);
  const isAuthEndpoint = req.url.includes("/auth/login") || req.url.includes("/auth/register") || req.url.includes("/auth/refresh") || req.url.includes("/auth/forgot-password") || req.url.includes("/auth/reset-password");
  if (isAuthEndpoint)
    return next(req);
...
var BottomNavComponent = class _BottomNavComponent {
  constructor() {
    this.navItems = [
      { path: "/home", label: "Home", icon: "\u{1F3E0}", activeIcon: "\u{1F3E0}" },
      { path: "/transactions", label: "Expenses", icon: "\u{1F4B3}", activeIcon: "\u{1F4B3}" },
      { path: "/wallet", label: "Wallet", icon: "\u{1F45B}", activeIcon: "\u{1F45B}" },
      { path: "/portfolio", label: "Portfolio", icon: "\u{1F4C8}", activeIcon: "\u{1F4C8}" },
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BottomNavComponent, selectors: [["app-bottom-nav"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [["role", "navigation", "aria-label", "Main navigation", 1, "bottom-nav"], ["routerLinkActive", "active", 1, "nav-item", 3, "routerLink"], ["aria-hidden", "true", 1, "nav-icon"], [1, "nav-label"]], template: function BottomNavComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "nav", 0);
        \u0275\u0275repeaterCreate(1, BottomNavComponent_For_2_Template, 5, 4, "a", 1, _forTrack0);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BottomNavComponent, { className: "BottomNavComponent", filePath: "src/app/shared/components/bottom-nav/bottom-nav.component.ts", lineNumber: 85 });
})();
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 1, consts: [[1, "app-shell"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275element(1, "router-outlet");
        \u0275\u0275template(2, AppComponent_Conditional_2_Template, 1, 0, "app-bottom-nav");
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
        \u0275\u0275conditional(2, ctx.authService.isLoggedIn() ? 2 : -1);
      }
